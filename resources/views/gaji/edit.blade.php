				...
				<div class="row">
				  <div class="col-12">
						<div class="card card-primary">
						  ...
						  <!-- /.card-header -->
						  <!-- form start -->
						  <form action="{{url('gaji/update', $gaji->id)}}" method="post">
							{{ csrf_field() }}
							<div class="card-body">
							  
							  <div class="form-group">
								<label for="pegawai_id">Pilih Pegawai</label>
								<input type="text" class="form-control" id="pegawai_id" name="pegawai_id" value="{{$gaji->pegawai->nama}}" readonly>
							  </div>
							  
							  <div class="form-group">
								<label for="gaji_pokok">Gaji Pokok</label>
								<input value=5000000 readonly type="text" class="form-control" id="gaji_pokok" name="gaji_pokok" value="{{ $gaji->gaji_pokok }}" required="required">
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
								...
								<input type="number" class="form-control" name="kalkulasi_potongan" value="{{ $gaji->kalkulasi_potongan }}" required="required">
							  </div>
							</div>
							<!-- /.card-body -->
